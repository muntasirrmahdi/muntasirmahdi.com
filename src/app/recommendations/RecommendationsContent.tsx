          ...
          <div className="flex flex-wrap gap-2 mb-10">
            {tabs.map((tab) => (
              <button
                ...
                className={
                  activeTab === tab.id
                    ? "rounded-lg bg-accent px-4 py-2 text-sm font-medium text-accent-foreground hover:scale-105 transition-transform duration-200"
                    : "rounded-lg border border-border bg-card px-4 py-2 text-sm text-muted hover:text-foreground hover:scale-105 transition-transform duration-200"
                }
              >
                {tab.label}
              </button>
